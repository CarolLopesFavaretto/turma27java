programa
{
	...
	funcao inicio(){
     ...
     funcao contaPoupanca(){
     	...
     	real correcao=0.0, saldoAtual=0.0, operacao=0.0, movimento=0.00, c=0.0, d=0.0
     	cadeia continua 
     	...
     	escreva("DIGITE A DATA DE ANIVERSARIO DA CONTA POUPANÇA:")
    		...
    		limpa()
     		...
     		se(diaAniversarioPoupanca == 5){
     			correcao = saldoAtual +(saldoAtual*0.05)
     		}
     		senao se((diaAniversarioPoupanca != 5)){
